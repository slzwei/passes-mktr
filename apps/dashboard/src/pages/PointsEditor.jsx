...
const PointsEditor = () => {
  ...
  const editorUrl = `${editorBase}?passType=points`;
  ...
  const handleSaveDraft = async () => {
    try {
      ...
      // Create a default points card design
      const draftData = {
        passType: 'points',
        cardType: 'points',
  ...
  const handleNextStep = () => {
    // Navigate to Campaign Details page with points card type
    const campaignData = {
      passType: 'points',
      cardType: 'points'
    };
    ...
    <div className="h-full flex flex-col" style={{ height: 'calc(100vh - 80px)' }}>
      ...
      <div className="flex items-center justify-between p-4 bg-white border-b border-gray-200">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-xl font-semibold text-gray-900">Points Card Editor</h1>
            <p className="text-sm text-gray-600">Design your points-based loyalty card</p>
          </div>
        </div>
        ...
        {isLoading && (
          <div className="absolute inset-0 flex items-center justify-center bg-gray-50 z-10">
            <div className="text-center">
              ...
              <p className="text-gray-600">Loading Points Card Editor...</p>
            </div>
          </div>
        )}
              ...
              <Alert className="border-red-200 bg-red-50">
                ...
                <AlertDescription className="text-red-800">
                  <div className="space-y-4">
                    <p className="font-medium">Failed to load Points Card Editor</p>
                    <p className="text-sm">
